...
## --- start section
    ...
    if(${type_name_up}_PLATFORM)
        set(${type_name_up}_WSP_CMMN_RPATH          ${${type_name_up}_ROOT_RPATH}/common/wsp )
...
## --- start section
    ...
    set(${type_name_up}_BUILD_EXT_RPATH               ${${type_name_up}_ROOT_RPATH}/build_main )
    set(${type_name_up}_BUILD_RPATH                   ${${type_name_up}_ROOT_RPATH}/build )
    if(${type_name_up}_PLATFORM)
        set(${type_name_up}_BUILD_EXT_PLTF_RPATH        ${${type_name_up}_ROOT_RPATH}/platform/${PLATFORM_NAME}/build_main )
        set(${type_name_up}_BUILD_EXT_RPATH             ${${type_name_up}_BUILD_EXT_PLTF_RPATH} )
        set(${type_name_up}_BUILD_PLTF_RPATH            ${${type_name_up}_ROOT_RPATH}/platform/${PLATFORM_NAME}/build )
