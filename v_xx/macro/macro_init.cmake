...
macro(call_rpath_include_macro MOD_NAME)
    ...
    ## if(${MOD_NAME} STREQUAL FNCT_BASE)
    ##     ## message(FATAL_ERROR "DEBUG - call_rpath_include_macro - MOD_NAME: ${MOD_NAME}")
    ##     include(${MPFW_CODE_CMAKE_DIR}/includes/set_public_rpaths.cmake)
    ##     ## include(${MPFW_CODE_CMAKE_DIR}/includes/set_public_rpath_base.cmake)
    ## elseif(${MOD_NAME} STREQUAL FNCT_HW_0ABST)
    ##     ## include(${MPFW_CODE_CMAKE_DIR}/includes/set_public_rpath_hw0.cmake)
    ##     include(${MPFW_CODE_CMAKE_DIR}/includes/set_public_rpaths.cmake)
    ## ## else()
    ## ##     ## include(${MPFW_CODE_CMAKE_DIR}/includes/set_public_rpaths.cmake)
