...
## *** Section  7 - BUILD LIBRARY CONFIGURATION COMMANDS
    ...
    if(NOT EXISTS ${MPFW_CODE_CMAKE_DIR}/scripts/get_deps_list.sh )
        ...
        ## message("DEBUG - auto-generate procedure - ${MODULE_NAME}_SOURCE_FILES_H_WDEP:   ${${MODULE_NAME}_SOURCE_FILES_H_WDEP}")
        message("DEBUG - auto-generate procedure - ${MODULE_NAME}_SOURCE_FILES_CPP:   ${${MODULE_NAME}_SOURCE_FILES_CPP}")
    endif()
    ...
    foreach(item IN LISTS test_exec_process)
        ...
        if(COL_LIST EQUAL 2)
            set(CPP_${service_name}_TBL_DIR_AUTO_GEN        "${${MODULE_NAME}_sdk_SRC_DIR}/auto_gen/${APP_NAME}/tb/${item}" )
